...
interface SyncJobsDailyProps {
  onNavigate?: (page: string) => void;
}

const SyncJobsDaily: React.FC<SyncJobsDailyProps> = ({ onNavigate }) => {
  const articles = [
    {
  ...
  return (
    <section className="py-20" style={{backgroundColor: '#EAF1FA'}}>
